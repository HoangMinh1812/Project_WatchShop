...
public class DiaChiActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng TMTStore = new LatLng(10.806712, 106.628790);
        mMap.addMarker(new MarkerOptions().position(TMTStore).title("TMT Store").snippet("Cửa hàng đồng hồ").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition  = new CameraPosition.Builder().target(TMTStore).zoom(90).build();
